...
VALUES
    ...
    (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 1, 'admin.onboard.process_address'), -- TODO: SWITCH TO OKHI AND DELETE
    ...
    (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 1, 'users.get.avatars'),
...
SET @AdminOnboardApproveAddressID = (SELECT id FROM permissions WHERE name = 'admin.onboard.process_address'); -- TODO: SWITCH TO OKHI AND DELETE
...
SET @UsersGetAvatarID = (SELECT id FROM permissions WHERE name = 'users.get.avatars');
