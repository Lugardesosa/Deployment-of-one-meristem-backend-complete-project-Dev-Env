...
SET @UsersOtpSendID = (SELECT id FROM permissions WHERE name = 'users.otp.send');
SET @UsersOtpVerifyID = (SELECT id FROM permissions WHERE name = 'users.otp.verify');
SET @UsersRiskUpdateID = (SELECT id FROM permissions WHERE name = 'users.risk.update');
...
SET @UsersActivityLogGetID = (SELECT id FROM permissions WHERE name = 'users.activity_log.get');
SET @UsersInstrumentAccessedID = (SELECT id FROM permissions WHERE name = 'users.instrument.accessed');
SET @UsersInstrumentGetID = (SELECT id FROM permissions WHERE name = 'users.instrument.get');
...
VALUES
    ...
    (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 'Trusties', 'MER-TRUSTEES'),
...
SET @WealthId = (SELECT id FROM investment_instruments WHERE code = 'MER-WEALTH');
SET @TrusteesId = (SELECT id FROM investment_instruments WHERE code = 'MER-TRUSTEES');
