...
$$
    ...
    BEGIN
        ...
        INSERT INTO permissions (created_date, created_by, last_modified_date, last_modified_by, version, status, name, code, description)
        VALUES (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 1, 'users.wealth.fund.ftip', '1056', 'Fixed term investment port-folio')
        RETURNING id INTO UsersWealthFundFtipID;

        INSERT INTO permissions (created_date, created_by, last_modified_date, last_modified_by, version, status, name, code, description)
        VALUES (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 1, 'users.wealth.fund.tlip', '1057', 'Treasury linked investment port-folio')
        RETURNING id INTO UsersWealthFundTlipID;

        INSERT INTO permissions (created_date, created_by, last_modified_date, last_modified_by, version, status, name, code, description)
        VALUES (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 1, 'users.wealth.infra.ilp', '1058', 'Infrastructure linked product')
        RETURNING id INTO UsersWealthInfraIlpID;

        INSERT INTO permissions (created_date, created_by, last_modified_date, last_modified_by, version, status, name, code, description)
        VALUES (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 1, 'users.wealth.exchange.mvetf', '1059', 'Values exchange traded fund')
        RETURNING id INTO UsersWealthExchangeMvetfID;

        INSERT INTO permissions (created_date, created_by, last_modified_date, last_modified_by, version, status, name, code, description)
        VALUES (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 1, 'users.wealth.exchange.mgetf', '1060', 'Growth exchange traded fund')
        RETURNING id INTO UsersWealthExchangeMgetfID;

        INSERT INTO permissions (created_date, created_by, last_modified_date, last_modified_by, version, status, name, code, description)
        VALUES (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 1, 'users.wealth.structure.meep', '1061', 'Ethical earning port folio')
        RETURNING id INTO UsersWealthStructureMeepID;

        INSERT INTO permissions (created_date, created_by, last_modified_date, last_modified_by, version, status, name, code, description)
        VALUES (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 1, 'users.wealth.structure.mdip', '1062', 'Dollar investment port folio')
        RETURNING id INTO UsersWealthStructureMdipID;

        INSERT INTO permissions (created_date, created_by, last_modified_date, last_modified_by, version, status, name, code, description)
        VALUES (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 1, 'users.wealth.structure.milp', '1063', 'Infrastructure linked product')
        RETURNING id INTO UsersWealthStructureMilpID;

        INSERT INTO permissions (created_date, created_by, last_modified_date, last_modified_by, version, status, name, code, description)
        VALUES (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 1, 'users.wealth.structure.reap', '1064', 'Real estate advantage port folio')
        ...
        INSERT INTO permissions (created_date, created_by, last_modified_date, last_modified_by, version, status, name,
                                 code, description)
        VALUES (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 1, 'system.admin.enable', '3007', 'Permission to enable and disable system administrators')
        RETURNING id INTO SystemAdminEnableAndDisableID;

        INSERT INTO permissions (created_date, created_by, last_modified_date, last_modified_by, version, status, name,
                                 code, description)
        VALUES (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 1, 'system.admin.get.address', '3014', 'Permission to enable and disable system administrators')
        ...
        VALUES (NOW(), 'SYSTEM', NOW(), 'SYSTEM', 0, 1, 'system.admin.user.update', '3008', 'Permission to add occupation and source of income')
        ...
        INSERT INTO permissions (created_date, created_by, last_modified_date, last_modified_by, version, status, name,
                                 code, description)
        VALUES (NOW(), 'SYSTEM', NOW(),'SYSTEM', 0, 1, 'users.create.spouse', '1049', 'Allow users to create their spouse details' )
