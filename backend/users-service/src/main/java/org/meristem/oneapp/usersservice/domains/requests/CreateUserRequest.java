...
public record CreateUserRequest(@Schema(example = "johndoe@gmail.com", description = "Pass the users email") @Email @NotBlank(message = "cannot be null") @Size(min = 5, max = 200, message = "cannot be longer than 200 and less than 5") String email,
                                ...
                                @Schema(example = "John", description = "Users first name") @Name(message = "alphabets, hyphen and one single quote allowed") @NotBlank(message = "cannot be blank") @Size(min = 1, max = 150, message = "cannot be less than 1 and more than 150") String firstName,
                                @Schema(example = "Doe", description = "Users last name") @Name(message = "alphabets, hyphen and one single quote allowed") @NotBlank(message = "cannot be blank") @Size(min = 1, max = 150, message = "cannot be less than 1 and more than 150") String lastName,
                                @Schema(example = "Obus", description = "Users middle name") @Name(message = "alphabets, hyphen and one single quote allowed") @Size(max = 150, message = "cannot be more than 150") String middleName,
