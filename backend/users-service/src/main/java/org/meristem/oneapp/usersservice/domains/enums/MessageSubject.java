...
public enum MessageSubject {
    ...
    SECONDARY_EMAIL_VERIFICATION (6, "You have been registered as a secondary user on One Meristem App"),
    EXISTING_EMAIL_VERIFICATION (7, "One Meristem Email verification OTP received ");
