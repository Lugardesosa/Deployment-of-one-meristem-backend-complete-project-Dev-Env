...
public record SubmitOnboardingRequest(@Schema(example = "1", description = "Pass the investmentRequirementId that the client has completed and want to record to the db") @NotNull(message = "Cannot be null") Long requirementId,
