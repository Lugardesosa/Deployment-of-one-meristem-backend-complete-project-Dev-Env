...
public record BvnUserRequest(@NotBlank(message = "Cannot be blank") @Schema(example = "MALE", allowableValues = {"MALE", "FEMALE"}, description = "pass the user's gender from the bvn") String gender,
