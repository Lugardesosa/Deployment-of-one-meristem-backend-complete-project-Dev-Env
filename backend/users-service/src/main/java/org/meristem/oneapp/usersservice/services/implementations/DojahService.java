...
public class DojahService implements IKycService {
    ...
    public UpdateResponse saveIdTask(IdVerificationRequest smileRequest) {
        ...
        org.meristem.oneapp.usersservice.models.Vendor vendor = amlVendorRepository.findAmlVendorByVendorCode(Vendor.DOJAH.getValue());
    ...
    private void handleData(SmileIdWebhookNotification notification, KycQuery kycQuery) {
        ...
        UserIdDetails userIdDetails = idDetailsService.buildAndSaveIdDetails(notification, loggedInUser);
