...
public record VerifyOtpRequest(@Schema(example = "3493", description = "The otp the user received") @Min(value = 1000, message = "cannot be less than 1000") @Max(value = 9999, message = "cannot be more than 9999") @NotNull(message = "otp cannot be null") Integer otp,
                               @Schema(allowableValues = {"1", "2"}, name = "otpType", anyOf = {MessageSubject.class}, example = "1", description = "Pass the same otpType that was passed when the otp was sent") @NotNull(message = "not null") @Max(value = 6, message = "not more than 2") @Min(value = 1, message = "not less than 1") Integer otpType,
