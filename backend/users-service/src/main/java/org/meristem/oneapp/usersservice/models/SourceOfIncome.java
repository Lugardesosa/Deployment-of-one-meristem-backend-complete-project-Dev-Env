...
@Setter
@Getter
@Table("source_of_income")
public class SourceOfIncome extends BaseModel<String> {

    @Size(max = 250, min = 1, message = "Not more than 250 and less than 5")
    private String name;

    @Builder
    public SourceOfIncome(Integer status, Long id, LocalDateTime createdDate, String createdBy, LocalDateTime lastModifiedDate, String lastModifiedBy,
    ...
    public boolean equals(Object o) {
        ...
        SourceOfIncome that = (SourceOfIncome) o;
