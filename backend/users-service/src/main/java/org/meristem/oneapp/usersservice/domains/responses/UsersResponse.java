...
public record UsersResponse(Integer status, Long id, String email, String firstName, String lastName, String middleName, @JsonIgnore String password, String phoneNumber, @JsonIgnore Integer passwordAttempt,
                            ...
                            LocalDate dateOfBirth, @Column("referral_code") String referralCode, @Column("onboarding_completed") Boolean onboardingCompleted, List<UserInstrumentResponse> userInstrumentResponses, Map<String, List<UserOptionResponse>> userOptionResponses, @JsonIgnore @Column("biometric_enabled") Boolean biometricEnabled) implements Serializable {
    ...
    public UsersResponse(Integer status, Long id, String email, String firstName, String lastName, String middleName, String phoneNumber,
                         String image, String gender, LocalDate dateOfBirth, String referralCode, Boolean onboardingCompleted, List<UserInstrumentResponse> userInstrumentResponses,  Map<String, List<UserOptionResponse>> userOptionResponses, Boolean biometricEnabled) {
    ...
    @Builder
    public record UserOptionResponse(Long id, String name, Boolean accessed) implements Serializable {
