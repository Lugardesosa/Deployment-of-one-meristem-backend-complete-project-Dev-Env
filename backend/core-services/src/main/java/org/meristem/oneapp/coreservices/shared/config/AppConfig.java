...
import org.meristem.oneapp.coreservices.shared.dtos.Serializer.BigDecimalTwoDecimalSerializer;
...
public class AppConfig {
    ...
    public OpenAPI apiDoclet(@Value("${one-app.server-url:http://localhost:20010/}") String serverUrl,
        ...
        server.description("Core API Documentation");
    ...
    public GroupedOpenApi notification() {
        return GroupedOpenApi.builder()
                .group("Notification")
                .packagesToScan("org.meristem.oneapp.coreservices.notifications.controller")
                .build();
    }
    @Bean
    public GroupedOpenApi wealth() {
        return GroupedOpenApi.builder()
                .group("Wealth")
                .packagesToScan("org.meristem.oneapp.coreservices.wealth.controllers")
                .build();
    }

    public GroupedOpenApi stockbroking() {
        return GroupedOpenApi.builder()
                .group("Stockbroking")
                .packagesToScan("org.meristem.oneapp.coreservices.wealth.controllers")
                .build();
