...
public class EmailService implements INotificationService<MessageDto> {

    @Value("${notification-service.one-app.notification-service.mail-sender}")
    public String FROM;
    @Value("${notification-service.one-app.notification-service.mail-sender-name}")
