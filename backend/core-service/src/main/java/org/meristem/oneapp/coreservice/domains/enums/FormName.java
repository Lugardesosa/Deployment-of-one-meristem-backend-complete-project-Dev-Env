...
public enum FormName {
    ...
    FINTECH_WALLET("Fintech Wallets", 4, AppConstants.FORM_TYPE_ASSET),
    REAL_ESTATE("Real Estate", 5, AppConstants.FORM_TYPE_ASSET),
    FIXED_INCOME_MONEY_MARKET("Fixed Income/Money Market", 6, AppConstants.FORM_TYPE_ASSET),
    INTELLECTUAL_PROPERTY("Intellectual Property", 7, AppConstants.FORM_TYPE_ASSET),
    ALTERNATE_ASSETS("Alternate Assets", 8, AppConstants.FORM_TYPE_ASSET),
    CRYPTOCURRENCY_AND_NFT("Cryptocurrencies & NFT", 9, AppConstants.FORM_TYPE_ASSET),
    DIGITAL_PLATFORM("Digital Platform", 10, AppConstants.FORM_TYPE_ASSET),
