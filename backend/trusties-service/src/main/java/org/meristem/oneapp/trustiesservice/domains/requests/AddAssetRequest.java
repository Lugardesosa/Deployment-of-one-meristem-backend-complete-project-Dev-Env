...
public record AddAssetRequest(
    ...
    public record Assets (
            ...
            @Schema(
                    ...
                    anyOf = {org.meristem.oneapp.trustiesservice.domains.enums.Assets.class},
                    example = "CASH"
            )
            @NotBlank(message = "Cannot be blank")
            @ContainsEnum(enumClass = org.meristem.oneapp.trustiesservice.domains.enums.Assets.class) String assetType) {}
}
